# ==========================================================================================================================================
# HIA code for Washington DC 2014, COPD 
# Started: 03102020
...
rate.groups <- c('copd_2014_cdc_100m')                  # doh = rates computed by DOH, wo doh = SEDAC rates
  names(rate.groups) <- c('copd_CDC')
...
getwd()
setwd("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/copd/")
    ...
    for (k in 1:length(rate.groups)){
      ...
      for (h in 1:length(pop.groups)){
        ...
        for (m in 1:length(city.groups)){
          ...
          file.exists("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/run/rates_dc/copd_2014_cdc_100m.tif") # check whether file exists in folder
          ...
          af <- mask(af, shp)
          #==============================================================================================================================================================    
          # f1 = paste('/GWSPH/home/mdcastillo/results/dc/pm25/copd/adults/af/',names(city.groups[m]),names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          f1 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/copd/af/",names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          # f2 = paste('/GWSPH/home/mdcastillo/results/dc/pm25/copd/adults/mr/',names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          f2 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/copd/mr/",names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          # f3 = paste('/GWSPH/home/mdcastillo/results/dc/pm25/copd/adults/paf/',names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          f3 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/copd/paf/",names(conc.groups[j]),', ',names(rate.groups[k]),', ',names(pop.groups[h]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          for (s in 1:length(clip.groups)){
            ...
            #            f4 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/copd/hia/",names(clips.shp[s]),' ',names(beta.groups[i]),' ',names(conc.groups[j]),' ',names(pop.groups[h]),' ',names(rate.groups[k]),'.tif',sep='')
            ...
            # subtitle=paste0('Range: ',rate.min.label,' to ',rate.max.label,' per 100,000. '),sep='')
            print(e_rate2)
            ggsave(paste('COPD_composite_',names(clips.shp[s]),names(beta.groups[i]),'_',names(rate.groups[k]),'.png',sep=''),dpi=300)
            #          ggsave(paste('COPD_composite_',names(clips.shp[s]),names(beta.groups[i]),'_',names(rate.groups[k]),'.tiff',sep=''),dpi=300)
            
            # require(ggplot2)
            # require(dplyr)
            # f5 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/fig1/",'COPD_fig1','_',names(clips.shp[s]),'_',names(beta.groups[i]),'_',names(rate.groups[k]),'.tif',sep='')
