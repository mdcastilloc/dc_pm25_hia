# ==========================================================================================================================================
#
# HIA, DC, IHD, 2011-2015 average PM2.5, pop and Rates/counts
# replace PM2.5 dataset with that of the 5-year average (for ihd 2011-2015)
...
# update filepath for outputs with /ihd_five/
...
beta.groups <- c(0.01310282624) 
  names(beta.groups) <- c('PE_ihd') #, 'LCI_ast', 'UCI_ast') #,'LCI','UCI')
count.groups <- c('ihd_11_15_doh')             # update to 5-year average counts
  names(count.groups) <- c('IHD_11_15_DOH')    
...
getwd()
setwd("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/ihd_doh/ihd_five_ave/")
    ...
    for (k in 1:length(count.groups)){
      ...
      for (h in 1:length(pop.groups)){   # note: remove the '}' at the end 
        ...
        for (m in 1:length(city.groups)){
          ...
          #==============================================================================================================================================================    
          # f1 = paste('/GWSPH/home/mdcastillo/results/dc/pm25/ihd_doh/adults/af/',names(city.groups[m]),names(conc.groups[j]),', ',names(count.groups[k]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          f1 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/ihd_doh/ihd_five_ave/af/",names(conc.groups[j]),', ',names(count.groups[k]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          ggsave(paste(names(city.groups[m]),' AF IHD and PM25 ',names(beta.groups[i]),' ',names(conc.groups[j]),' ',names(count.groups[k]),'.png',sep=''),
          ...
          f2 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/ihd_doh/ihd_five_ave/mr/",names(conc.groups[j]),', ',names(count.groups[k]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          ggsave(paste(names(city.groups[m]),' MR IHD and PM25 ',names(beta.groups[i]),' ',names(conc.groups[j]),' ',names(count.groups[k]),'.png',sep=''),
                 width = 8, height = 10, dpi = 300, units = "in")
          print('mr')
          ...
          # f3 = paste('/GWSPH/home/mdcastillo/results/dc/pm25/ihd_doh/adults/paf/',names(conc.groups[j]),', ',names(count.groups[k]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          f3 = paste("/Users/mdcc/Box/dc_hia/HIA_calculations_mc/results/ihd_doh/ihd_five_ave/paf/",names(conc.groups[j]),', ',names(count.groups[k]),', ',names(beta.groups[i]),', ',names(city.groups[m]),'.tif',sep='')
          ...
          paf_plot <- ggplot()  +
            ...
            geom_path(data = shp.f, aes(x = long, y = lat, group = group), 
                      color = "grey60", size = 0.5)+
            labs(title=bquote('IHD Excess Mortality Attributable to '~PM[2.5]~''),
          ...
          ggsave(paste(names(city.groups[m]),' PAF IHD and PM25 excess cases, ',names(beta.groups[i]),' ',names(conc.groups[j]),' ',names(count.groups[k]),'.png',sep=''),
                 width = 8, height = 10, dpi = 300, units = "in")
          print('hia')
...
#  CHECK HERE ******************************************************
            ...
            print(e_rate3)
            ggsave(paste('IHD_comp_color ',names(clips.shp[s]),', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',names(count.groups[k]),'.png',sep=''),
                   width = 8, height = 10, dpi = 300, units = "in")
            print("comp_rates_cols")
            ...
            e_count <- ggplot() +
              ...
              theme (plot.title = element_text(face="bold", hjust = 0.5, size = 23),
                     ...
                     legend.title = element_text(size=18), legend.text = element_text(size=18))
            print(e_count)
            ggsave(paste('IHD_comp_count ',names(clips.shp[s]),', ',names(conc.groups[j]),', ',names(beta.groups[i]),', ',names(count.groups[k]),'.png',sep=''),
                   width = 8, height = 10, dpi = 300, units = "in")
            print("comp_counts")
